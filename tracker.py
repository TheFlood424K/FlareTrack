...
class ChronicTracker:
    ...
    def log_environment(self, **kwargs) -> EnvironmentEntry:
        ...
        print(f"[Tracker] Logged environmental factors")
        return entry
    
    def get_environment_by_date(self, date_str: str = None) -> Optional[EnvironmentEntry]:
